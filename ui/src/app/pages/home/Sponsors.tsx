  ...
  return (
    <section className="sm:flex sm:items-center justify-center">
      <div className="">
        ...
        <div className="grid grid-cols- sm:grid-cols-4 gap-5 place-items-center">
          {sponsors.map((sponsor, i) => (
            <div
              key={i}
              className="flex items-center justify-center gap-3 text-sm bg-white rounded-xl shadow-md hover:shadow-md transition p-4 hover:scale-105 duration-300 max-w-full w-xs sm:sm"
            >
